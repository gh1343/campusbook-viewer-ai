...
import { X, Sidebar, Pen, Columns2, Bookmark, PanelRight, CloudUpload, Highlighter, Eraser, Square, AlertCircle, BookOpen, RefreshCw, CloudOff } from 'lucide-react';
...
export const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  const features = [
    ...
    },
    {
      ...
      title: "텍스트 선택 및 강조",
      location: "본문 영역",
      description: "글자를 길게 누르거나 드래그하여 선택한 뒤 형광펜으로 강조할 수 있습니다.",
      colorClass: "help_feature_icon_emerald"
    },
    {
      icon: <span className="help_view_mode_icons"><Square size={14} /><Columns2 size={14} /></span>,
      title: "보기 모드",
      location: "상단 중앙",
      description: "한 쪽 보기 또는 두 쪽 보기 모드를 설정합니다.",
      colorClass: "help_feature_icon_slate"
    },
    {
      icon: <span className="help_drawing_icons"><Pen size={14} /><Highlighter size={14} /><Eraser size={14} /></span>,
      title: "필기 도구",
      location: "상단 중앙",
    ...
    },
    {
      ...
      title: "안심 저장 및 동기화",
      location: "우측 상단",
      description: "학습 데이터를 보호하는 2단계 저장 시스템입니다. 직접 저장 버튼을 눌러 소중한 기록을 기기와 클라우드에 안전하게 보관하세요.",
      ...
      <div className="help_modal_container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="help_toolbar_map_wrap">
          <div className="help_toolbar_map_inner">
            ...
            <p className="help_toolbar_map_text">상단 툴바를 통해 모든 기능을 제어할 수 있습니다.</p>
          </div>
        </div>
              ...
              <div key={idx} className="help_feature_item">
                ...
                <div className="help_feature_text">
                  <div className="help_feature_title_row">
                    ...
                    <span className="help_feature_location">{feature.location}</span>
                  </div>
          ...
          <div className="help_system_section">
            <div className="help_system_grid">
              <div className="help_system_box help_system_blue">
                ...
                <p className="help_system_box_desc">데이터 보호를 위해 상단의 저장 버튼을 꼭 눌러주세요. 버튼을 누르면 네트워크 상태와 관계없이 기기에 즉시 기록됩니다.</p>
              </div>
              <div className="help_system_box help_system_amber">
                ...
                <p className="help_system_box_desc">상단 '기기 저장됨' 아이콘 확인 시, 안정적인 네트워크에서 '동기화 완료'까지 기다려주세요.</p>
              </div>
              <div className="help_system_box help_system_rose">
                <h5 className="help_system_box_title help_system_title_rose">데이터 동기화</h5>
                <p className="help_system_box_desc help_system_desc_rose">이전 버전(V2)의 데이터는 현재 뷰어(V3)와 동기화되지 않으니 이용에 참고해 주세요.</p>
              </div>
            </div>
            ...
            <div className="help_device_notice">
              <div className="help_device_notice_left">
                ...
                <p className="help_device_notice_text">iOS 17 이상 권장 · 기기 사양 및 환경에 따라 구동이 다를 수 있음</p>
              </div>
              <p className="help_device_notice_sub">최신 브라우저 환경에서 가장 원활하게 작동합니다.</p>
            </div>
          </div>
        </div>
